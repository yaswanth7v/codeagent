...
class ChromaVectorStore:
    ...
    def _create_embedding_function(self):
        ...
        return SentenceTransformerEmbeddingFunction(self.encoder)
    ...
    def build_index(self, chunks: List[CodeChunk]) -> None:
        ...
        self.collection = self.client.create_collection(
            ...
            embedding_function=self.embedding_function  # Use custom embedding function
        )
    ...
    def load(persist_directory: str = "./chroma_db",
        ...
        try:
            vector_store.collection = vector_store.client.get_collection(
                ...
                embedding_function=vector_store.embedding_function  # Use custom embedding function
            )
